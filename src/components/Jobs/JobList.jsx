          ...
          <table className="min-w-full table-auto">
            <thead className="bg-indigo-300 text-black text-xl ">
              <tr>
                ...
                <th className="py-3 px-6 border-r-2  border-richblack-300 font-semibold">
                  Ship
                </th>
                <th className="py-3 px-6 border-r-2  border-richblack-300 font-semibold">
                  Priority
            ...
            <tbody>
              {jobs.map((job) => (
                ...
                >
                  <td className="py-3 px-6 border-r border-black/20">
                    {job.type}
                  </td>
                  <td className="py-3 px-6 border-r border-black/20">
                    {getData("components").find((c) => c.id === job.componentId)
                      ?.name || "N/A"}
                  </td>
                  <td className="py-3 px-6 border-r border-black/20">
                    {getData("ships").find((s) => s.id === job.shipId)?.name ||
                      "N/A"}
                  </td>
                  <td className="py-3 px-6 border-r border-black/20">
                    {job.priority}
